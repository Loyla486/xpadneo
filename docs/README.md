...
* [xow](https://github.com/medusalix/xow) is a driver for the Xbox One S controllers, too, and supports the native
  adapters packaged with the controller. Kudos to [@medusalix](https://github.com/medusalix) for working together on
...
in Bluetooth mode. In the future, xpadneo may support audio when USB and adapter support will be added.
...
This controller uses BLE (Bluetooth low energy) and can only be supported if your Bluetooth adapter also supports BLE.
...
* [Compatible BT adapters](https://atar-axis.github.io/xpadneo/#bt-dongles)
